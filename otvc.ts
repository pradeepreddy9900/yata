...
export class OtvcPage extends BasePage implements OnInit {
  constructor(public navCtrl: NavController, public rootService: RootService, public otvcGatewayService: OTVCGatewayService,
    public loadingService: LoadingService,public errorHandler: AppErrorHandler,public stateTransitionService:StateTransitionService,public location: Location, public pageInitService: PageInitService,public errorEventHandler: ErrorEventHandlerService,public cibcPopupFactory: CIBCPopupFactory,  public commonGatewayService: Commonpostsignongatewayservice,

public reportingErrorHandler: ReportingErrorHandler, public otvcService: OTVCService, public otvcValidator: OtvcValidatorService, 
